...
from .modules import SSLBackbone, SSLProjectionHead

class SSLModel(nn.Module):
    def __init__(self, backbone_dim, scale_dim, projection_dim):
        super().__init__()
        self.backbone = SSLBackbone(out_dim=backbone_dim, scale_dim=scale_dim)
