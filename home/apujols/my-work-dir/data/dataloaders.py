...
def get_ssl_loader(data_root, batch_size, transform):
    dataset = MyMeteorDataset(folder=data_root, transform=transform)
    loader = DataLoader(
        dataset,
...
def get_labeled_loaders(data_root, csv_file, batch_size, transform, val_split=0.2):
